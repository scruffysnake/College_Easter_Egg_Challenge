...
public static class Easter
{
    ...
    public enum Trials
    {
        ...
        TRIAL3, 
        TRIAL4,
        // needed real value for CurrentTrial
        Null
    }
    // Trial 1 (Caesar)
    ...
    static void Trial1()
        => Console.WriteLine(@"
    I received an encrypted message from the easter bunny, but the key was never received the key!!!
    I heard somewhere that the easter bunny is a fan of Caesar Ciphers, so I feel it's best to see if it's a Caesar Cipher or not.
    ...
    Once you think you have a solution to the trial you can submit it to the function Easter.Submit and it'll return true/false depending if you got the solution correct.
    If you need a hint, you can run the procedure Easter.Hint() and it will output some hints for the trial you are currently on.
